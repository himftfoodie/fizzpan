  ...
  return (
    <>
      <div className="flex h-screen bg-gray-50 overflow-hidden">
        {/* Sidebar */}
        <aside
          className={`fixed top-0 left-0 h-full bg-white border-r border-gray-200 transition-all duration-300 z-40 flex flex-col ${open ? "w-64" : "-translate-x-full"
            } ${isScreenSmall ? "shadow-xl" : ""}`}
        >
          {/* Sidebar Header */}
          <div
            className="h-20 flex items-center justify-between px-6 border-b border-gray-200"
        ...
        {/* Main Content */}
        <div
          className={`flex-1 flex flex-col transition-all duration-300 ${open && !isScreenSmall ? "ml-64" : "ml-0"
            }`}
        >
          {/* Top Navbar */}
